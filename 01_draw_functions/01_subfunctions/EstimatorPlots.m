...
if topics.vehicle_attitude.logged
    ...
    hold on;
    plot(quatTime, roll*180./pi);
    plot(quatTime, pitch*180./pi);
    plot(quatTime, yaw*180./pi);
    hold off;
