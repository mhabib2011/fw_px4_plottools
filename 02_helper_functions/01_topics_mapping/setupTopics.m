...
topics.vehicle_local_position_setpoint = ...
    struct('topic_name', 'vehicle_local_position_setpoint', 'logged', false, 'num_instances', 0);
...
topics.vtol_vehicle_status = ...
    struct('topic_name', 'vtol_vehicle_status', 'logged', false, 'num_instances', 0);
topics.ts_controls = ...
    struct('topic_name', 'ts_controls', 'logged', false, 'num_instances', 0);